...
info:
  ...
  goals:
    ...
    - To design and implement a network protocol with a client and a server
  rubric:
    - weight: 60
...
![ASCII Table from Wikipedia](https://commons.wikimedia.org/w/index.php?title=Special:Redirect/file/ASCII-Table-wide.svg
